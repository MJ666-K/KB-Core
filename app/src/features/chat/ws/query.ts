...
import { chatSessions, datasets } from '@core/db/schema';
import { eq, and } from 'drizzle-orm';
import type { Message } from '@infra/llm/llm-service';
import { getAgent } from '@features/chat/agent/registry';
import type { EventStream } from '@features/chat/agent/types';
import { logger } from '@core/utils/logger';
import { getLastRetrievalDetails } from '@features/kb/tools/search-knowledge';
import { resolveBearerToken } from '@infra/auth/service';
import { hasPermission } from '@infra/auth/permission-registry';
import {
  createQueryJob,
  appendQueryJobEvent,
  completeQueryJob,
...
} from '@infra/auth/query-job-store';

...
import type { Tool, ToolContext } from '@features/kb/tools/types';
import type { PivotConfig, VisualizationData } from '@core/db/schema/excel';
import { getDuckDBService } from '@features/excel/analyze/duckdb-service';
import { db } from '@core/db/client';
import { excelProfiles, pivotTables } from '@core/db/schema';

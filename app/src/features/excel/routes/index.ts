...
import { getDuckDBService } from '@features/excel/analyze/duckdb-service';
import { db } from '@core/db/client';
import { excelProfiles, pivotTables, excelReports } from '@core/db/schema';
import { eq, desc } from 'drizzle-orm';
import { queryExcelTool } from '@features/excel/tools/query-excel';
import { generateCodeTool } from '@features/excel/tools/generate-code';
...
请确保报告专业、简洁、有洞察力。`;
  ...
  const { LLMService } = await import('@infra/llm/llm-service');
  const llm = new LLMService();
